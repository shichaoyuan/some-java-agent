 ...
 */
public class JokerDescriptionStrategy implements AgentBuilder.DescriptionStrategy {
    ...
    public JokerDescriptionStrategy(String nameTrait) {
    ...
    static class SWTypeDescriptionWrapper extends TypeDescription.AbstractBase implements Serializable {
        ...
        private static final List<String> IGNORED_INTERFACES = Collections.emptyList();
        ...
        public FieldList<FieldDescription.InDefinedShape> getDeclaredFields() {
            if (this.fields == null) {
                ...
                if (typeCache.fieldNames == null) {
                    ...
                    System.out.println("fields: " + declaredFields);
            ...
            System.out.println("cached fields: " + fields);
            return fields;
        }
        ...
        public MethodList<MethodDescription.InDefinedShape> getDeclaredMethods() {
            if (this.methods == null) {
                ...
                if (typeCache.methodCodes == null) {
                    ...
                    System.out.println("methods: " + declaredMethods);
            ...
            System.out.println("cached methods: " + methods);
            return methods;
        }
